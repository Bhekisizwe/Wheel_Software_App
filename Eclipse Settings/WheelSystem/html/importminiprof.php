                        ...
                        success: function (data) {
                            ...
                            $("#uploadButton").prop("disabled", false);
                           	if(data["transactionStatus"]){
								...
								if(confirm("Click OK if you have completed uploading all the wheel measurements for this set number?")){
									//we have completed uploading. Send email
									$("#uploadButton").val("SENDING EMAILS...");
									$("#uploadButton").prop("disabled", true);
									objData={};
									objData["setNumber"]=$("#setNumber").val();
									objData["measurementDate"]=$("#measurementDate").val();
            						...
            						cache: false,						
										success: function (data) {
				                            ...
				                            $("#uploadButton").prop("disabled", false);																	               							
											if(data["transactionStatus"]){
												alert("Successfully sent emails to stakeholders to enter manual wheel measurements!");								
												//location.reload();													
											}
											else{												
												...
												else if(data["errorAssocArray"]["errorCode"]=="0x21"){											    	
											    	alert(data["errorAssocArray"]["errorDescription"]);											    	
										    	}									
										    	else{								    	
								...
								else alert("Continue uploading the MiniProf wheel measurement files for this set number");
                           	}
                           	else{
                           		if(data["errorAssocArray"]["errorCode"]=="0x19"){
							    	//session has expired
