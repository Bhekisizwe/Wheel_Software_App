...
class ManualWheelMeasurementsTest extends TestCase
{
     ...
     */
    public function testGetWheelReportDataOutOfRangeDates()
    {
        ...
        $arr=array();
        $arr["reportStartDate"]="2018-04-07";
        $arr["reportEndDate"]="2018-04-07";
        $this->data->set($arr);
        $arr_result=$this->manualWheelMeasurements->getWheelReportData($this->data);
        $this->assertEquals(0,count($arr_result));
    }
    
    public function testGetWheelReportDataDatesWithinRange()
    {
        // TODO Auto-generated ManualWheelMeasurementsTest->testGetWheelReportData()
        //$this->markTestIncomplete("getWheelReportData test not implemented");
        $arr=array();
        $arr["reportStartDate"]="2017-04-07";
        $arr["reportEndDate"]="2017-04-07";
        $this->data->set($arr);
        $arr_result=$this->manualWheelMeasurements->getWheelReportData($this->data);
